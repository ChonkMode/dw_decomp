...
rm -rf "$BIN_DIR/wibo" "$BIN_DIR/wibo-x86_64" "$BIN_DIR/wibo-i686"
...
if "$BIN_DIR/wibo-i686" --version >/dev/null 2>&1; then
    ln -s wibo-i686 "$BIN_DIR/wibo"
else
    ln -s wibo-x86_64 "$BIN_DIR/wibo"
fi
