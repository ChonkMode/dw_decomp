...
extern int32_t FISH_REEL_TARGET_Z[];
...
seadraChase:
	FISH_SCRATCH->unk18 = getDistance(
		FISH_REEL_TARGET_X[0] - FISHING_DATA_PTR->hooked.fish.pos.vx, 0,
		FISH_REEL_TARGET_Z[0] - FISHING_DATA_PTR->hooked.fish.pos.vz);
	k = FISH_SCRATCH->unk18;
	k = (k < 0) ? 0 : ((FISH_SCRATCH->unk18 >= 0x33) ? 0x32 : k);
	FISH_SCRATCH->unk18 = k;
	toEulerAngles(&h->fish.rotation, FISH_REEL_TARGET_X[0] - h->fish.pos.vx, 0,
	              FISH_REEL_TARGET_Z[0] - h->fish.pos.vz);
	FISH_SCRATCH->v0.vx = 0;
	FISH_SCRATCH->v0.vy = 0;
	FISH_SCRATCH->v0.vz = FISH_SCRATCH->unk18;
	rotateVectorYXZ(&h->fish.rotation, &FISH_SCRATCH->v0, &FISH_SCRATCH->v1);
...
state11AF:
	...
	FISH_SCRATCH->unk18 = getDistance(FISH_REEL_TARGET_X[0] -
	                                          FISHING_DATA_PTR->hooked.fish.pos.vx,
	                                  0,
	                                  FISH_REEL_TARGET_Z[0] -
